...
#### [2.17.1](https://github.com/code-corps/stripity_stripe/compare/2.15.1...2.17.1)

- Add back a way to delete subscription [`#753`](https://github.com/code-corps/stripity_stripe/pull/753)
- Fix CI [`#754`](https://github.com/code-corps/stripity_stripe/pull/754)
- Stripe API version 2020-08-27 [`#748`](https://github.com/code-corps/stripity_stripe/pull/748)
- Add support for Stripe Test Clocks [`#723`](https://github.com/code-corps/stripity_stripe/pull/723)
- Fix typo [`#745`](https://github.com/code-corps/stripity_stripe/pull/745)
- Search API [`#738`](https://github.com/code-corps/stripity_stripe/pull/738)
- Fix create and update subscription spec [`#739`](https://github.com/code-corps/stripity_stripe/pull/739)
- invoice line items proration details [`#741`](https://github.com/code-corps/stripity_stripe/pull/741)
- Update session.ex [`#743`](https://github.com/code-corps/stripity_stripe/pull/743)
- Add us_bank_account & more debits to PaymentMethod [`#742`](https://github.com/code-corps/stripity_stripe/pull/742)
- Add missing `default_price` to Stripe.Product [`#740`](https://github.com/code-corps/stripity_stripe/pull/740)

#### [2.15.1](https://github.com/code-corps/stripity_stripe/compare/2.15.0...2.15.1)

> 27 June 2022

- fix credit note line item spec [`#737`](https://github.com/code-corps/stripity_stripe/pull/737)
- CHANGELOG 2.15.0 [`e164b8f`](https://github.com/code-corps/stripity_stripe/commit/e164b8f8fff723050d8b49af89ba24bcaa39d2de)
...
- Update changelog [`#696`](https://github.com/code-corps/stripity_stripe/pull/696)
