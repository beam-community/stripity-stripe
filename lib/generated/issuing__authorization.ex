...
defmodule Stripe.Issuing.Authorization do
    ...
    (
      @spec list(
              params :: %{
                ...
                optional(:status) => :closed | :expired | :pending | :reversed
              },
              opts :: Keyword.t()
            ) ::
  ...
  (
    ...
    @doc "<p>Respond to a fraud challenge on a testmode Issuing authorization, simulating either a confirmation of fraud or a correction of legitimacy.</p>\n\n#### Details\n\n * Method: `post`\n * Path: `/v1/test_helpers/issuing/authorizations/{authorization}/fraud_challenges/respond`\n"
    (
      @spec respond(
              authorization :: binary(),
              params :: %{optional(:confirmed) => boolean, optional(:expand) => list(binary)},
              opts :: Keyword.t()
            ) ::
              {:ok, Stripe.Issuing.Authorization.t()}
              | {:error, Stripe.ApiErrors.t()}
              | {:error, term()}
      def respond(authorization, params \\ %{}, opts \\ []) do
        path =
          Stripe.OpenApi.Path.replace_path_params(
