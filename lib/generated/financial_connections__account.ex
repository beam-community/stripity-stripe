...
defmodule Stripe.FinancialConnections.Account do
  ...
  (
    ...
    @doc "<p>Subscribes to periodic refreshes of data associated with a Financial Connections <code>Account</code>. When the account status is active, data is typically refreshed once a day.</p>\n\n#### Details\n\n * Method: `post`\n * Path: `/v1/financial_connections/accounts/{account}/subscribe`\n"
    (
      @spec subscribe(
              account :: binary(),
              params :: %{
