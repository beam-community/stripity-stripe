    ...
    (
      @spec upcoming(
              params :: %{
                ...
                optional(:subscription_proration_behavior) => :always_invoice | :create_prorations | :none,
    ...
    (
      @spec create(
              params :: %{
                ...
                optional(:payment_settings) => payment_settings,
                optional(:pending_invoice_items_behavior) => :exclude | :include | :include_and_require,
                optional(:rendering) => rendering,
                optional(:rendering_options) => rendering_options | binary,
