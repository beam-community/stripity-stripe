...
defmodule Stripe.Identity.VerificationSession do
  ...
  (
    @typedoc "Tokens referencing a Person resource and it's associated account."
    @type related_person :: %{optional(:account) => binary, optional(:person) => binary}
  )
    ...
    (
      @spec create(
              params :: %{
                ...
                optional(:related_customer) => binary,
                optional(:related_person) => related_person,
