defmodule Stripe.ConfirmationToken do
  ...
  (
    @typedoc "Configuration for any card payments confirmed using this ConfirmationToken."
  ...
  (
    @typedoc "Installment configuration for payments confirmed using this ConfirmationToken."
  ...
  (
    @typedoc "Payment-method-specific configuration for this ConfirmationToken."
    @type payment_method_options :: %{optional(:card) => card}
  )

  (
    @typedoc "The selected installment plan to use for this payment attempt.\nThis parameter can only be provided during confirmation."
    @type plan :: %{
