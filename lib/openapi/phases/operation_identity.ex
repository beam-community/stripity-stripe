defmodule Stripe.OpenApi.Phases.OperationIdentity do
  ...
  @operation_identity_mapping %{
    ...
    {"PostTestHelpersIssuingCardsCardShippingSubmit",
     "/v1/test_helpers/issuing/cards/{card}/shipping/submit", "submit_card"} => "submit_card",
    ...
    {"PostBillingMeterEventAdjustments", "/v1/billing/meter_event_adjustments", "create"} =>
      "create",
    {"GetBillingCreditBalanceSummary", "/v1/billing/credit_balance_summary", "retrieve"} =>
      "retrieve",
    {"PostBillingMeterEvents", "/v1/billing/meter_events", "create"} => "create",
    {"GetInvoicePayments", "/v1/invoice_payments", "list"} => "list",
    {"GetInvoicePaymentsInvoicePayment", "/v1/invoice_payments/{invoice_payment}", "retrieve"} =>
      "retrieve",
    ...
    {"PostTestHelpersIssuingAuthorizationsAuthorizationFraudChallengesRespond",
     ...
     "respond"} => "respond",
    {"GetBillingCreditBalanceTransactions", "/v1/billing/credit_balance_transactions", "list"} =>
      "list",
    {"GetBillingCreditBalanceTransactionsId", "/v1/billing/credit_balance_transactions/{id}",
     "retrieve"} => "retrieve",
    ...
    {"PostBillingCreditGrantsIdExpire", "/v1/billing/credit_grants/{id}/expire", "expire"} =>
      "expire",
    {"PostBillingCreditGrantsIdVoid", "/v1/billing/credit_grants/{id}/void", "void_grant"} =>
      "void_grant",
    ...
    {"PostTreasuryFinancialAccountsFinancialAccountClose",
     "/v1/treasury/financial_accounts/{financial_account}/close", "close"} => "close",
  ...
  @doc """
  Converts an operation to a function name.

  ## Examples

      iex> Stripe.OpenApi.Phases.OperationIdentity.to_func_name(%OpenApiGen.Blueprint.Operation{
      ...>   id: "GetProducts",
      ...>   path: "/v1/products",
      ...>   method: :get
      ...> }, %{"method_name" => "list"})
      "list"
  """
  @spec to_func_name(OpenApiGen.Blueprint.Operation.t(), map()) :: String.t()
  def to_func_name(operation, stripe_extension) do
