defmodule Stripe.EventsTest do
  ...
  setup_all do
    use_cassette "Stripe.EventsTest/setup" do
      ...
      on_exit fn ->
        use_cassette "Stripe.EventsTest/teardown" do
  ...
  @tag disabled: false
  test "Count works" do
    use_cassette "Stripe.EventsTest/count" do
  ...
  test "Count w/key works" do
    use_cassette "Stripe.EventsTest/count_with_key" do
  ...
  @tag disabled: false
  test "List works" do
    use_cassette "Stripe.EventsTest/list" do
  ...
  test "List w/key works" do
    use_cassette "Stripe.EventsTest/list_with_key" do
  ...
  test "List w/paging works" do
    use_cassette "Stripe.EventsTest/list_with_key_and_paging" do
  ...
  @tag disabled: false
  test "Get works" do
    use_cassette "Stripe.EventsTest/get" do
  ...
  test "Get w/key works" do
    use_cassette "Stripe.EventsTest/get_with_key" do
    {:ok, events} = Stripe.Events.list "",1
    evt = hd events[:data]
