defmodule Stripe.SourceTest do
  ...
  describe "attach/2" do
    test "attaches a source to a customer" do
      assert {:ok, %Stripe.BankAccount{}} = Stripe.Source.attach(%{customer: "cus_123", source: "src_123"})
  ...
  describe "detach/2" do
    test "detaches a source from a customer" do
      assert {:ok, %Stripe.BankAccount{}} = Stripe.Source.detach("src_123", %{customer: "cus_123"})
