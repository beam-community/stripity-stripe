defmodule Stripe.ChargeTest do
  ...
  test "is captureable with idempotency opts" do
    ...
    assert_stripe_requested(:post, "/v1/charges/ch_123/capture", headers: {"Idempotency-Key", "test"})
  end
  ...
  test "is retrievable with expansions opts" do
    ...
    assert_stripe_requested(:get, "/v1/charges/ch_123", query: %{"expand[0]": "balance_transaction"})
  end
