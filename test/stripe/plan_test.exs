defmodule Stripe.PlanTest do
  ...
  setup_all do
    use_cassette "Stripe.PlanTest/setup" do
  ...
  test "Creation" do
    use_cassette "Stripe.PlanTest/create" do
  ...
  test "Creation w/key" do
    use_cassette "Stripe.PlanTest/create_with_key" do
  ...
  test "Count w/key" do
    use_cassette "Stripe.PlanTest/count_with_key" do
  ...
  test "Plan change" do
    use_cassette "Stripe.PlanTest/change" do
  ...
  test "Plan change w/key" do
    use_cassette "Stripe.PlanTest/change_with_key" do
  ...
  test "Listing plans" do
    use_cassette "Stripe.PlanTest/list" do
  ...
  test "Listing plans w/key" do
    use_cassette "Stripe.PlanTest/list_with_key" do
  ...
  test "Plan deletion" do
    use_cassette "Stripe.PlanTest/delete" do
  ...
  test "Plan deletion w/key" do
    use_cassette "Stripe.PlanTest/delete_with_key" do
  ...
  test "All" do
    use_cassette "Stripe.PlanTest/all" do
  ...
  test "All w/key" do
    use_cassette "Stripe.PlanTest/all_with_key" do
  ...
  test "Delete all" do
    use_cassette "Stripe.PlanTest/delete_all" do
  ...
  test "Delete all w/key" do
    use_cassette "Stripe.PlanTest/delete_all_with_key" do
