defmodule Stripe.SubscriptionTest do
  ...
  setup_all do
    use_cassette "Stripe.SubscriptionTest/setup" do
      ...
      on_exit fn ->
        use_cassette "Stripe.SubscriptionTest/teardown" do
  ...
  test "Count works", %{customer: customer, sub1: _, sub2: _}  do
    use_cassette "Stripe.SubscriptionTest/count" do
  ...
  test "Count w/key works", %{customer: customer, sub1: _, sub2: _}  do
    use_cassette "Stripe.SubscriptionTest/count_with_key" do
  ...
  test "Retrieving single works", %{customer: customer, sub1: sub1, sub2: _} do
    use_cassette "Stripe.SubscriptionTest/get" do
  ...
  test "Retrieving single w/key works", %{customer: customer, sub1: sub1, sub2: _} do
    use_cassette "Stripe.SubscriptionTest/get_with_key" do
  ...
  test "Retrieve all works", %{customer: customer} do
    use_cassette "Stripe.SubscriptionTest/all" do
  ...
  test "Create w/opts  works", %{customer: customer, sub1: _, sub2: _} do
    use_cassette "Stripe.SubscriptionTest/create_with_opts" do
  ...
  test "Create w/opts w/key works", %{customer: customer, sub1: _, sub2: _} do
    use_cassette "Stripe.SubscriptionTest/create_with_key_with_opts" do
  ...
  test "Change works", %{customer: customer, sub1: sub1, sub2: _} do
    use_cassette "Stripe.SubscriptionTest/change" do
  ...
  test "Change w/key works", %{customer: customer, sub1: _, sub2: sub2} do
    use_cassette "Stripe.SubscriptionTest/change_with_key" do
  ...
  test "Cancel works", %{customer: customer, sub1: sub1, sub2: _} do
    use_cassette "Stripe.SubscriptionTest/cancel" do
  ...
  test "Cancel w/key works", %{customer: customer, sub1: _, sub2: sub2} do
    use_cassette "Stripe.SubscriptionTest/cancel_with_key" do
  ...
  test "Cancel at period end works", %{customer: customer, sub3: sub3} do
    use_cassette "Stripe.SubscriptionTest/cancel_at_period_end" do
  ...
  test "Change creditcards works", %{customer: c, sub2: sub2} do
    use_cassette "Stripe.SubscriptionTest/change_payment_source" do
      source = [
        object: "card",
  ...
  test "Cancel all works", %{customer: customer,  sub1: _, sub2: _} do
    use_cassette "Stripe.SubscriptionTest/cancel_all" do
  ...
  test "Cancel all w/key  works", %{customer: customer,  sub1: _, sub2: _} do
    use_cassette "Stripe.SubscriptionTest/cancel_all_with_key" do
