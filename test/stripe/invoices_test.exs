defmodule Stripe.InvoicesTest do
  ...
  setup_all do
    use_cassette "Stripe.InvoicesTest/setup" do
      ...
      on_exit fn ->
        use_cassette "Stripe.InvoicesTest/teardown" do
  ...
  test "Metadata works", %{customer1: customer1, sub1: sub1}  do
    use_cassette "Stripe.InvoicesTest/metadata" do
      params = [
        subscription: sub1.id,
        metadata: [
          app_order_id: "ABC123",
  ...
  @tag disabled: false
  test "Count works", %{}  do
    use_cassette "Stripe.InvoicesTest/count" do
  ...
  test "Count w/key works", %{}  do
    use_cassette "Stripe.InvoicesTest/count_with_key" do
  ...
  @tag disabled: false
  test "List works", %{}  do
    use_cassette "Stripe.InvoicesTest/list" do
  ...
  test "List w/key works", %{}  do
    use_cassette "Stripe.InvoicesTest/list_with_key" do
  ...
  test "Get works", %{customer1: _, sub1: _} do
    use_cassette "Stripe.InvoicesTest/get" do
      {:ok,invoices} = Stripe.Invoices.list Stripe.config_or_env_key,"", 1
  ...
  test "Get w/key works", %{customer1: _, sub1: _} do
    use_cassette "Stripe.InvoicesTest/get_with_key" do
      {:ok,invoices} = Stripe.Invoices.list Stripe.config_or_env_key,"", 1
      first = Enum.at invoices[:data], 0
  ...
  test "Upcoming works", %{customer1: customer1, sub1: sub1} do
    use_cassette "Stripe.InvoicesTest/upcoming" do
  ...
  test "Upcoming w/key works", %{customer1: customer1} do
    use_cassette "Stripe.InvoicesTest/upcoming_with_key" do
